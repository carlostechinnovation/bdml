...
mysql -u root --password=datos1986 --execute="SELECT COUNT(*) as contador FROM datos_desa.tb_galgos_carreras LIMIT 1\W;"
echo -e "Filas insertadas en historico de galgos: " >&1
mysql -u root --password=datos1986 --execute="SELECT COUNT(*) as contador FROM datos_desa.tb_galgos_historico LIMIT 1\W;"
