...
public class Constantes {
	...
	public static final Integer GALGOS_UMBRAL_DIAS_CARRERAS_ANTERIORES = 14 * 7;// Ultimas X semanas
	...
	public static final Integer MAX_NUM_CARRERAS_SEMILLA = 100; // SOLO ESTUDIAMOS LOS GALGOS DE ESTAS CARRERAS (y las
																// derivadas)
