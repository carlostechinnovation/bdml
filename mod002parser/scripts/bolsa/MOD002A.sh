...
mysql -u root --password=datos1986 --execute="SELECT CONCAT(tabla.ticker,'.MC') FROM ( SELECT distinct ticker FROM datos_desa.tb_gf01 WHERE ticker NOT LIKE '%.%' ORDER BY ticker ) tabla;" > "/home/carloslinux/Desktop/GIT_REPO_BDML/bdml/mod002parser/scripts/bolsa/empresas_yahoo_finance.in"
