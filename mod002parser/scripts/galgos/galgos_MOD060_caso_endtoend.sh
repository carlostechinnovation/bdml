...
mysql --login-path=local -t --execute="$CONSULTA_ANTES_DE_PREDECIR" 2>&1 1>>${LOG_060_ENDTOEND}${TIEMPO}
...
mysql --login-path=local -t --execute="$CONSULTA_DESPUES_DE_PREDECIR_0" 2>&1 1>>${LOG_060_ENDTOEND}${TIEMPO}
...
mysql --login-path=local -t --execute="$CONSULTA_DESPUES_DE_PREDECIR_1o2" 2>&1 1>>${LOG_060_ENDTOEND}${TIEMPO}
...
mysql --login-path=local -t --execute="$CONSULTA_DESPUES_DE_PREDECIR_1st" 2>&1 1>>${LOG_060_ENDTOEND}${TIEMPO}
