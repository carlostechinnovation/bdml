...
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_cg_semillas_sportium;" >> "${LOG_020_ESTADISTICA}"

######################################################################################################
echo -e "-------------- TABLAS BRUTAS (pasadas + futuras) --------------" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_carreras:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_carreras;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_posiciones_en_carreras:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_posiciones_en_carreras;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_historico:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_historico;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_agregados:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_agregados;" >> "${LOG_020_ESTADISTICA}"
...
echo -e "tb_galgos_carreras:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_carreras_LIM;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_posiciones_en_carreras:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_posiciones_en_carreras_LIM;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_historico:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_historico_LIM;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_agregados:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_agregados_LIM;" >> "${LOG_020_ESTADISTICA}"
...
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_carreras_norm;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_posiciones_en_carreras_norm:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_posiciones_en_carreras_norm;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_historico_norm:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_historico_norm;" >> "${LOG_020_ESTADISTICA}"
echo -e "tb_galgos_agregados_norm:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -tN --execute="SELECT count(*) FROM datos_desa.tb_galgos_agregados_norm;" >> "${LOG_020_ESTADISTICA}"
...
mysql -u root --password=datos1986 -t --execute="SELECT * FROM datos_desa.tb_galgos_carreras_norm WHERE id_carrera<=50 ORDER BY id_carrera LIMIT 12;" >> "${LOG_020_ESTADISTICA}"
...
mysql -u root --password=datos1986 -t --execute="SELECT id_carrera, count(*) AS contador FROM datos_desa.tb_galgos_posiciones_en_carreras_norm WHERE id_carrera<=50 GROUP BY id_carrera HAVING contador>6 ORDER BY id_carrera LIMIT 10;" >> "${LOG_020_ESTADISTICA}"

echo -e "\n\ntb_galgos_historico_norm --> Deben aparecer los historicos (artificiales) de una carrera futura:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -t --execute="SELECT * FROM datos_desa.tb_galgos_historico_norm WHERE id_carrera<=50 ORDER BY id_carrera LIMIT 10;" >> "${LOG_020_ESTADISTICA}"
...
mysql -u root --password=datos1986 -t --execute="SELECT galgo_nombre, count(*) AS contador FROM datos_desa.tb_galgos_agregados_norm GROUP BY galgo_nombre HAVING contador>=2 LIMIT 10;" >> "${LOG_020_ESTADISTICA}"
...
mysql -u root --password=datos1986 -t --execute="SELECT posicion, count(*) as contador FROM datos_desa.tb_galgos_historico WHERE remarks LIKE '%Crd%' GROUP BY posicion ORDER BY posicion ASC LIMIT 10;" >> "${LOG_020_ESTADISTICA}"

echo -e "Wide:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -t --execute="SELECT posicion, count(*) as contador FROM datos_desa.tb_galgos_historico WHERE remarks LIKE '%Wide%' GROUP BY posicion ORDER BY posicion ASC LIMIT 10;" >> "${LOG_020_ESTADISTICA}"

echo -e "RanOn:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -t --execute="SELECT posicion, count(*) as contador FROM datos_desa.tb_galgos_historico WHERE remarks LIKE '%RanOn%' GROUP BY posicion ORDER BY posicion ASC LIMIT 10;" >> "${LOG_020_ESTADISTICA}"

echo -e "Led:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -t --execute="SELECT posicion, count(*) as contador FROM datos_desa.tb_galgos_historico WHERE remarks LIKE '%Led%' GROUP BY posicion ORDER BY posicion ASC LIMIT 10;" >> "${LOG_020_ESTADISTICA}"

echo -e "AlwaysLed:" >> "${LOG_020_ESTADISTICA}"
mysql -u root --password=datos1986 -t --execute="SELECT posicion, count(*) as contador FROM datos_desa.tb_galgos_historico WHERE remarks LIKE '%AlwaysLed%' GROUP BY posicion ORDER BY posicion ASC LIMIT 10;" >> "${LOG_020_ESTADISTICA}"
