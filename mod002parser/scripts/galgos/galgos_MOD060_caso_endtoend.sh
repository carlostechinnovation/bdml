...
then
  ...
  echo -e "\n############################ CARRERA FUTURA: $id_carrera_analizada #############################################\n" 2>&1 1>>${LOG_060_ENDTOEND}${TIEMPO}
  ...
  echo -e "\n############################ CARRERA PASADA: $id_carrera_analizada #############################################\n" 2>&1 1>>${LOG_060_ENDTOEND}${TIEMPO}
fi
#####################################################################################################
...
select * from datos_desa.tb_galgos_posiciones_en_carreras WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;

select * from datos_desa.tb_galgos_historico WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;
...
SELECT A.galgo_nombre FROM datos_desa.tb_filtrada_galgos_${SUBGRUPO} A WHERE A.galgo_nombre IN (SELECT galgo_nombre FROM datos_desa.tb_filtrada_carrerasgalgos_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ) ORDER BY galgo_nombre ASC
LIMIT 10;

SELECT id_carrera, galgo_nombre, velocidad_con_going_norm FROM datos_desa.tb_filtrada_carrerasgalgos_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;

SELECT * FROM datos_desa.tb_ds_pasado_validation_featuresytarget_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;
SELECT * FROM datos_desa.tb_ds_futuro_features_id_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;
EOF
...
SELECT * FROM datos_desa.tb_val_1st_aciertos_connombre_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 6;
SELECT * FROM datos_desa.tb_fut_1st_connombre_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 6;

SELECT * FROM datos_desa.tb_fut_1st_predicho_completo_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} LIMIT 6;

select * FROM datos_desa.tb_val_1st_riesgo_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;
SELECT * FROM datos_desa.tb_fut_1st_final_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;

select * FROM datos_desa.tb_val_1st_economico_${SUBGRUPO}_SP10099900 WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;
SELECT * FROM datos_desa.tb_fut_1st_final_riesgo_${SUBGRUPO} WHERE id_carrera=${id_carrera_analizada} ORDER BY galgo_nombre ASC LIMIT 10;
EOF
