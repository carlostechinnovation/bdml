...
mysql -u root --password=datos1986 --execute="SELECT COUNT(*) as num_galgos_iniciales_SPORTIUM FROM datos_desa.tb_cg_semillas_sportium LIMIT 1\W;" 2>&1 1>>${PATH_LOG}
