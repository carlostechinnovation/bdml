...
public class Constantes {
	...
	// -------------- GALGOS --------
	public static Integer GALGOS_UMBRAL_DIAS_CARRERAS_ANTERIORES = 14 * 7;// Ultimas X semanas
	public static Integer MAX_NUM_CARRERAS_SEMILLA = 20; // SOLO ESTUDIAMOS LOS GALGOS DE ESTAS CARRERAS (y las
	// derivadas)
