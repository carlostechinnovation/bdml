...
#A.Limpieza
mysql -u root --password=datos1986 --execute="DROP TABLE IF EXISTS datos_desa.tb_mod005_001_a\W;"
mysql -u root --password=datos1986 --execute="DROP TABLE IF EXISTS datos_desa.tb_mod005_001_b\W;"
...
#A.Limpieza
mysql -u root --password=datos1986 --execute="DROP TABLE IF EXISTS datos_desa.tb_mod005_002_a\W;"
mysql -u root --password=datos1986 --execute="DROP TABLE IF EXISTS datos_desa.tb_mod005_002_b\W;"
...
#D. Informe FINAL
mysql -u root --password=datos1986 -t --execute="SELECT id_periodo, ticker, precio_inicio, precio_fin, diferencia_porcentaje FROM datos_desa.tb_mod005_002_b WHERE diferencia_porcentaje > 3 ORDER BY id_periodo DESC, diferencia_porcentaje DESC\W;" >> ${PATH_INFORME_002}
